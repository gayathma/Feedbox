...
header("Content-Disposition: attachment; filename=Patient_Feedback_Report.xls"); //File name extension was wrong
header("Expires: 0");
        ...
        <div class="col-sm-12 bk">
            <div class="panel">
                <div class="panel-body large">
                    <h3>Patient Feedback for the month of <?php echo $month;?></h3>
                    ...
                    <div class="adv-table">
                        <table class="display table table-bordered ">
                            ...
                            $patient_service = new Patients_service();
                            foreach ($feed_back_sheets as $feed_back_sheet) {
                                $patient = $patient_service->get_patient_by_id($feed_back_sheet->patient_id);
                                ?>
                                <tr>
                                    <td><?php echo date('M - y', strtotime($get_month));?></td>
                                    <td><?php echo (!empty($patient)) ? $patient->ward_no : " ";?></td>
                                    <td><?php echo ++$i;?></td>
                                    <?php
