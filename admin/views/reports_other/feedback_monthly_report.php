        ...
        <div>
            <header class="panel-heading">
                <a href="<?php echo site_url(); ?>/login/load_login"><i
                        class="fa fa-arrow-left"></i>Monthly Customer Feedback Report</a>
...
<script type="text/javascript">
    ...
    function export_report(){
        if($("#month_report").valid()){
            var win = window.open(site_url + '/reports/generate_feedback_export?month=' + $("#month").val()+'&questionnaire=' + $("#questionnaire").val(), '_blank');
            win.focus();
        }
    }
